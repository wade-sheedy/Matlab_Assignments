function varargout = Wade_Sheedy_12509031_Assignment_3(varargin)
% WADE_SHEEDY_12509031_ASSIGNMENT_3 MATLAB code for Wade_Sheedy_12509031_Assignment_3.fig
%      WADE_SHEEDY_12509031_ASSIGNMENT_3, by itself, creates a new WADE_SHEEDY_12509031_ASSIGNMENT_3 or raises the existing
%      singleton*.
%
%      H = WADE_SHEEDY_12509031_ASSIGNMENT_3 returns the handle to a new WADE_SHEEDY_12509031_ASSIGNMENT_3 or the handle to
%      the existing singleton*.
%
%      WADE_SHEEDY_12509031_ASSIGNMENT_3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WADE_SHEEDY_12509031_ASSIGNMENT_3.M with the given input arguments.
%
%      WADE_SHEEDY_12509031_ASSIGNMENT_3('Property','Value',...) creates a new WADE_SHEEDY_12509031_ASSIGNMENT_3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Wade_Sheedy_12509031_Assignment_3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Wade_Sheedy_12509031_Assignment_3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Wade_Sheedy_12509031_Assignment_3

% Last Modified by GUIDE v2.5 23-May-2017 16:13:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Wade_Sheedy_12509031_Assignment_3_OpeningFcn, ...
                   'gui_OutputFcn',  @Wade_Sheedy_12509031_Assignment_3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Wade_Sheedy_12509031_Assignment_3 is made visible.
function Wade_Sheedy_12509031_Assignment_3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Wade_Sheedy_12509031_Assignment_3 (see VARARGIN)

% Choose default command line output for Wade_Sheedy_12509031_Assignment_3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Wade_Sheedy_12509031_Assignment_3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Wade_Sheedy_12509031_Assignment_3_OutputFcn(hObject, eventdata, handles) 
...
% openfile();
        ...
        line = fgetl(FileID);     
        j = 1;  % allows my data to get placed into the next line of the array
while ischar(line)
